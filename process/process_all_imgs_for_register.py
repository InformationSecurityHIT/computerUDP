...
if __name__ == "__main__":
    ...
    # imagePath ="D:\\InfoSecur\\code\\wkr\\data_before\\wrll"
    # destRoot =  "D:\\InfoSecur\\code\\wkr\\data_after\\wrll"
    # keyPoint = "D:\\InfoSecur\\code\\wkr\\KeyPoint\\wrll"
    ...
    for image in images:
        ...
        #name = image.split('.')[0]
        extract_feature.pretreatment(imagePath + "\\" + image, image.split('.')[0], destRoot)
