...
public class DBBean {
     ...
     * @return
     */
    public int executeCreateNewTable(String tableName) {
        int result = 0;
        String sql = null;
     ...
     * @return dbBean.executeUpdate(" ' wkr ' ", " nameandpassword ",
     ...
     * 向数据库中插入一个数据
     *
     * @param table_name 数据库的表名及参数名   eg:search.table(id,name,age)
